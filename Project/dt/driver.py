    ...
    for i, var_y in enumerate(y_labels):
        ...
        if not variable_importance_only:
            ...
            plot_multivar_decision_regions(
                var_y, test_preds, predictors_ordered_var, y_var_unique_classes, decision_tree_model.X_test, decision_tree_model.X_labels, predict_callback, delta=4, dataset_name=dataset_name, plots_folder_path=plots_folder_path)
